    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='patterns.patterntype', verbose_name='Tipo')),
            ],
            options={
                'verbose_name': 'Patrón',
        ...
        migrations.AddField(
            ...
            name='category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='patterns.businessprocesscateggory', verbose_name='Categoria'),
        ),
    ]
